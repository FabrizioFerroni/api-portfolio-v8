...
import { MySQLInterfaceRepository } from './mysql.base.interface';
...
export abstract class MySQLAbstractRepository<T extends HasId>
  implements MySQLInterfaceRepository<T>
{
